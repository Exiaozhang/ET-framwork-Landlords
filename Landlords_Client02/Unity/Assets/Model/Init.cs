    ...
    public class Init : MonoBehaviour
    {
        ...
        private async ETVoid StartAsync()
        {
            try
            {
                ...
                //加上消息分发组件MessageDispatcherCompoent
                ...
                //G2C_MyTestMessage myG2CTestMessage = (G2C_MyTestMessage)await session.Call(new C2G_MyTestMessage() { Info = "==>>Server Frined,Hello!Responed!" });
