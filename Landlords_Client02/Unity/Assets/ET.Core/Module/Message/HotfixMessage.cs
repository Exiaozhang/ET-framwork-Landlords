...
namespace ETModel {
  ...
  ///My向服务器发送消息
  /// </summary>
  public partial class C2G_MyTestMessage : pb::IMessage {
    private static readonly pb::MessageParser<C2G_MyTestMessage> _parser = new pb::MessageParser<C2G_MyTestMessage>(() => (C2G_MyTestMessage)MessagePool.Instance.Fetch(typeof(C2G_MyTestMessage)));
    public static pb::MessageParser<C2G_MyTestMessage> Parser { get { return _parser; } }
  ...
  ///My向服务器发送消息向服务器返回消息
  /// </summary>
  public partial class G2C_MyTestMessage : pb::IMessage {
    private static readonly pb::MessageParser<G2C_MyTestMessage> _parser = new pb::MessageParser<G2C_MyTestMessage>(() => (G2C_MyTestMessage)MessagePool.Instance.Fetch(typeof(G2C_MyTestMessage)));
    public static pb::MessageParser<G2C_MyTestMessage> Parser { get { return _parser; } }
